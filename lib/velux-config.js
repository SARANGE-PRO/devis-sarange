...
export const buildVeluxDesignation = (selection = {}) => {
  ...
  // La référence commerciale reste pure : Uw/Sw n'y figurent pas. Ils sont
  // ajoutés en DERNIÈRE LIGNE de la description (cf. handleVeluxValidate dans
  // components/ProductSelector.jsx), exactement comme pour les menuiseries
  // catalogue — voir lib/designation-generator.js.
