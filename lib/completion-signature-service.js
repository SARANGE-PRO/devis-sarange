...
const buildInternalCompletionHtml = ({ clientName, completionNumber, hasReserves, quoteNumber, adresse, reserves = [], ratings = null, photoLinks = [] }) => {
  ...
  if (smtp.internalEmail) {
    try {
      await transport.sendMail({
        ...
        html: buildInternalCompletionHtml({ clientName, completionNumber, hasReserves, quoteNumber, adresse, reserves, ratings, photoLinks }),
