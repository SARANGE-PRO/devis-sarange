...
// Même mécanique pour les pièces jointes supplémentaires (PDF, JPG, PNG) :
// la zone de transit ne présume pas du type, le serveur le vérifie à l'envoi.
export const uploadQuoteDeliveryFile = uploadQuoteDeliveryPdf;
