...
export const buildCompletionPdfDocument = async ({
  ...
  const issueDateLabel = formatCompletionDateTime(issueDate);
  ...
  const adresseChantier = composeCompletionAddress(
    clientData?.adresseChantier,
    clientData?.codePostalChantier,
    clientData?.villeChantier
  );
