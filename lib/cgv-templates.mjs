...
// 2026.08.1 : ajout de l'article 4.5 (5% en cas de réserves à la réception,
// avec pose) — voir lib/completion-certificate.mjs.
// 2026.08.2 : réécriture de l'article 4.5 en « échéance finale en cas de
// réserves » : modalité contractuelle de paiement (95 % exigibles à la
// réception, 5 % à la levée écrite des réserves), qui ne relève PAS de la
// loi n° 71-584 du 16 juillet 1971 — l'ancien texte s'y référait à tort.
export const CGV_VERSION = '2026.08.2';
  ...
  const article4 = withPose
    ? {
        ...
        text: joinSentences(
          ...
          "4.5. Échéance finale en cas de réserves : lorsque des réserves sont formulées lors de la réception des travaux, le montant total exigible à cette date est limité à 95 % du montant total TTC du devis, déduction faite des sommes déjà encaissées. Le solde contractuel de 5 % constitue une échéance distincte, non exigible à la date de réception. Il devient exigible dès la levée écrite de l'ensemble des réserves mentionnées au procès-verbal de réception. La levée des réserves est constatée par écrit ou par validation électronique du maître d'ouvrage après réalisation des corrections correspondantes. Cette modalité de paiement est convenue dès l'acceptation du devis et ne constitue pas une retenue de garantie au sens de la loi n° 71-584 du 16 juillet 1971."
        ),
      }
    : {
...
/**
 * Un devis n'ouvre droit au mécanisme des 5 % du bon de fin de chantier
 * (échéance finale en cas de réserves, lib/completion-certificate.mjs) que si
 * SES CGV figées au moment de sa signature contenaient déjà la clause
 * (article 4.5, ajoutée en 2026.08.1 puis reformulée en 2026.08.2).
 ...
 * Les deux rédactions historiques sont reconnues : l'ancienne (« 4.5. Retenue
 * de garantie », snapshots 2026.08.1 figés à jamais) et l'actuelle
 * (« 4.5. Échéance finale en cas de réserves »).
 */
export const cgvSnapshotEntryHasRetentionClause = (cgvSnapshotEntry) => {
  ...
  if (typeof article4?.text !== 'string') return false;
  return (
    article4.text.includes('4.5. Retenue de garantie') ||
    article4.text.includes('Échéance finale en cas de réserves')
  );
};
