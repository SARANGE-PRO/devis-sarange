...
export const CGV_VERSION = '2026.07';

const SIRET_SARANGE = '82000101400027';
...
export const buildCgvSections = ({
  ...
  const article7 = isPro
    ...
    : {
        ...
        text: joinSentences(
          ...
          `Conformément aux articles L. 616-1 et R. 616-1 du Code de la consommation, ${consumerName} peut, après échec de la procédure prévue ci-dessus, recourir gratuitement à la médiation de la consommation en s'adressant au CM2C : par courrier électronique : cm2c@cm2c.net ; par courrier postal : CM2C, 49 rue de Ponthieu, 75008 Paris ; par dépôt en ligne : cm2c.net/declarer-un-litige.php.`,
  ...
  return [preambule, article1, article2, article3, article4, article5, article6, article7];
};
