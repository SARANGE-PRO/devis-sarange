...
// Publication hebdomadaire (voir .github/workflows/dgfip-vat-index.yml) : le
// seuil tolère deux publications manquées avant de signaler un index figé.
const STALE_AFTER_DAYS = 21;

export const DGFIP_INDEX_STALE_ALERT =
  'L’index DGFiP des numéros de TVA n’a pas été actualisé depuis plus de vingt et un jours. Les vérifications peuvent utiliser des données anciennes.';
