...
// Publication mensuelle (voir .github/workflows/dgfip-vat-index.yml) : le seuil
// laisse une marge d'un cycle complet avant de signaler un index figé.
const STALE_AFTER_DAYS = 35;

export const DGFIP_INDEX_STALE_ALERT =
  'L’index DGFiP des numéros de TVA n’a pas été actualisé depuis plus de trente-cinq jours. Les vérifications peuvent utiliser des données anciennes.';
