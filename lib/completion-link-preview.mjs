...
export const GENERIC_COMPLETION_LINK_TEXTS = Object.freeze({
  status: 'generic',
  title: 'Votre bon SARANGE en ligne',
  description:
    'Travaux terminés, livraison ou enlèvement : validez la prestation et signez votre bon en ligne en quelques secondes.',
  headline: 'Votre bon SARANGE',
  subline: 'Travaux terminés, livraison ou enlèvement : validez et signez en ligne.',
  details: '',
  badge: 'Valider et signer',
});
