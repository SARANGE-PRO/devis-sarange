import { UNKNOWN_CLIENT_TYPE, normalizeClientType, normalizeSiret } from './client-type.mjs';
...
export const EMPTY_CLIENT_DATA = {
  ...
  // SIRET optionnel (renseigné automatiquement par la recherche d'entreprise
  // en mode PROFESSIONNEL). Jamais obligatoire.
  siret: '',
  nom: '',
  prenom: '',
  adresse: '',
