import { formatPhoneNumber, getPhoneComparisonKey } from './phone.mjs';
import {
  UNKNOWN_CLIENT_TYPE,
  normalizeClientType,
  normalizeSiren,
...
// Ré-export : le formatage des numéros vit dans lib/phone.mjs, mais tout ce qui
// manipule une fiche client passe déjà par ce module.
export { formatPhoneNumber, getPhoneComparisonKey } from './phone.mjs';
...
export const sanitizeClientData = (clientData = {}) => {
  ...
  return {
    ...
    // Numéro mis en forme dès la normalisation : la saisie, la fiche client,
    // le devis et le PDF affichent tous « 06 62 68 90 84 », y compris pour les
    // fiches enregistrées avant cette mise en forme.
    telephone: formatPhoneNumber(normalized.telephone),
...
export const buildClientSearchText = (clientData = {}) => {
  ...
  return [
    ...
    // Clé canonique : un client enregistré en « +33 6 62 … » reste trouvable en
    // tapant « 0662689084 ».
    getPhoneComparisonKey(normalized.telephone),
    normalized.email,
