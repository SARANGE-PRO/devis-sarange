...
export const buildMenuiserieConfig = ({ sheetName, width, height, options = {} }) => {
  ...
  // Menuiserie cintrée (catégorie « Formes spéciales ») : uniquement sur les
  // menuiseries à frappe. En imposte, la hauteur dessinée = partie basse +
  // flèche ; en cintre intégré, l'arc est compris dans la hauteur saisie.
  const cintrage =
    type === 'frappe'
